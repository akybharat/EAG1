...
async def draw_rectangle(x1: int, y1: int, x2: int, y2: int) -> dict:
    ...
    try:
        ...
        # rectangle_button = paint_window.child_window(auto_id="RectangleButton", control_type="Button") 
        ...
        paint_window.click_input(coords=(532, 85))
        # rectangle_button.click_input()
        time.sleep(1)
        ...
        paint_window.click_input(coords=(x1+250, y1+250))
        canvas.press_mouse_input(coords=(x1+250, y1+250))
        canvas.move_mouse_input(coords=(x2+250, y2+250))
        canvas.release_mouse_input(coords=(x2+250, y2+250))
...
async def add_text_in_paint(text: str) -> dict:
    ...
    try:
        ...
        paint_window.click_input(coords=(532, 25))
        time.sleep(1)
        ...
        canvas.click_input(coords=(350, 300))
        time.sleep(0.5)
    ...
    try:
        ...
        return {
            "content": [
                TextContent(
                    type="text",
                    text="Paint opened successfully on monitor and maximized"
                )
            ]
        }
    except Exception as e:
